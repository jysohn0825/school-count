package com.jysohn0825.core

import org.junit.jupiter.api.Assertions.assertTrue
import org.junit.jupiter.api.Test


class ExtractSchoolTest {
    ...
    fun test() {
        ...
        val keywords = listOf("대학교", "고등학교", "중학교", "초등학교", "대학", "여대", "여고", "남고", "예고", "외고", "통상", "여중", "남중", "대", "고", "중", "초")

        val keywordRegex = keywords.joinToString("|") { Regex.escape(it) }

        val pattern = "($keywordRegex)(?:\\S+\\s*)*".toRegex()

        val result = SAMPLE_TEXT.replace(pattern, "$1")
        assertTrue(true)
    }
